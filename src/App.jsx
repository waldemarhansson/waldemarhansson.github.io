...
function App() {
  ...
  const videoSource = isDesktop ? vimeoreel169 : vimeoreel916;
  ...
  return (
    ...
    <div className="App">
      <section id='section0'>
        ...
        <FirstVideo videoSource={videoSource} isDesktop={isDesktop} />
        <StandingImage />
      ...
      {isDesktop ? (
        <section id="section3">
          <LayingVideoWithChoise aspectRatio="1 / 1" video={"https://player.vimeo.com/progressive_redirect/playback/1037217899/rendition/1080p/file.mp4?loc=external&log_user=0&signature=24564b7664b74d0c377e464a40509e8789eb360de279c8841b7e7054c39cfc56"} />
          <SingleLayingVideo />
        ...
        <section id="section4">
          <LayingVideoWithChoise aspectRatio="1 / 1" video={"https://player.vimeo.com/progressive_redirect/playback/1036104648/rendition/1080p/file.mp4?loc=external&log_user=0&signature=55665f7ac37707189e6d78d64abe86ff1446b57d3d5b65c65a68d8a4396ff429"} />
          <LayingVideoWithChoise aspectRatio="1 / 1" video={"https://player.vimeo.com/progressive_redirect/playback/1037217899/rendition/1080p/file.mp4?loc=external&log_user=0&signature=24564b7664b74d0c377e464a40509e8789eb360de279c8841b7e7054c39cfc56"} />
          <SingleLayingVideo />
